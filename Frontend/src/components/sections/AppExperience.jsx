...
import { appExperienceScreens } from '../../data/mockData';
...
const infographicSteps = appExperienceScreens.slice(0, 4);
    ...
    <section id="experience" className="relative py-12 md:py-24 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <SectionHeading 
          ...
          subtitle="Explore the intuitive features built directly into the Haion mobile app for an effortless purchase journey."
        />
