...
export default function ProfilePage({ onClose }) {
  ...
  const userName = latestOrder?.name || "Guest Customer";
  const userPhone = latestOrder?.phone || "+91 98765 43210";
  const userAddress = latestOrder?.address || "No saved shipping address yet.";
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between border-b border-zinc-200 pb-4">
          ...
          <div className="text-right">
            <span className="text-[10px] font-bold text-amber-600 uppercase tracking-widest block">HAION CLUB</span>
            <h1 className="text-2xl font-black font-display text-zinc-900">My Profile</h1>
          </div>
        </div>
            ...
            <div className="bg-white border border-zinc-200/80 rounded-3xl p-6 relative overflow-hidden shadow-xs">
              ...
              <div className="mt-6 space-y-3.5 border-t border-zinc-100 pt-5">
                <div className="flex items-center gap-3 text-xs">
                  ...
                  <div>
                    <span className="text-zinc-400 block text-[10px] font-bold uppercase tracking-wider">Email Address</span>
                    <span className="text-zinc-700 font-semibold">haion.user@guest.com</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 text-xs">
                  ...
                  <div>
                    <span className="text-zinc-400 block text-[10px] font-bold uppercase tracking-wider">Phone Number</span>
                ...
                <div className="flex items-start gap-3 text-xs">
                  ...
                  <div>
                    <span className="text-zinc-400 block text-[10px] font-bold uppercase tracking-wider">Default Shipping Address</span>
