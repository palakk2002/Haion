...
export default function ScrollSequence() {
  ...
  // Define text overlays at specific scroll progress milestones
  const overlays = [
    {
      start: 0.05,
      end: 0.35,
      title: "Cinematic Engineering",
      highlight: "Uncompromising Design",
      desc: "Every component sculpted for aerodynamics and premium aesthetics."
    },
    {
      start: 0.40,
      end: 0.70,
      ...
      desc: "Watch as components elegantly slide and fit into place under the hood."
    },
    {
      start: 0.75,
      end: 0.95,
      title: "56L Smart Boot Space",
      highlight: "Haion EV Storage",
      desc: "Massive storage compartment, designed to carry all your big little things."
    }
  ];
