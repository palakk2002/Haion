    ...
    <section id="contact" className="relative py-12 md:py-24 bg-[#f8f9fa] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <SectionHeading 
          ...
          subtitle="Have questions about listing your brand on our app, custom partnership agreements, or support tickets?"
        />
              ...
              <div className="glassmorphism rounded-3xl p-8 flex flex-col justify-between h-full border-black/5">
                <div>
                  ...
                  <p className="text-zinc-500 text-sm font-light leading-relaxed mb-8">
                    Feel free to reach out directly. Our global partner relationship offices and dedicated expert support teams are here to help.
                  </p>
                ...
                <div className="mt-12 pt-8 border-t border-black/5 text-[10px] text-zinc-400">
                  Customer response time average: &lt; 5 minutes
                </div>
              </div>
            </ScrollReveal>
          </div>
              ...
              <GlassCard className="p-8 md:p-10 text-left h-full flex flex-col justify-between border-black/5" hoverEffect={false}>
                <div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <label htmlFor="name" className="text-[10px] text-zinc-400 uppercase font-semibold block mb-2">Your Name</label>
                      <input
                        type="text"
                        id="name"
                        required
                    ...
                    <div>
                      <label htmlFor="email" className="text-[10px] text-zinc-400 uppercase font-semibold block mb-2">Email Address</label>
                      <input
                        type="email"
                        id="email"
                        required
                    ...
                    <div>
                      <label htmlFor="message" className="text-[10px] text-zinc-400 uppercase font-semibold block mb-2">Message</label>
                      <textarea
                        id="message"
                        required
                        rows={4}
                ...
                <AnimatePresence>
                  {isSubmitted && (
                    ...
                    >
                      ...
                      <span>Thank you! Your inquiry was submitted. We will email you back shortly.</span>
                    </motion.div>
                  )}
                </AnimatePresence>
