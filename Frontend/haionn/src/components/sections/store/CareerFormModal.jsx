  ...
  const validateStep = () => {
    ...
    if (step === 1) {
      ...
      if (!formData.reasonToJoin) {
        setError('Please explain why you want to join Power Safe Industries.');
        return false;
      }
    } else if (step === 4) {
          ...
          {isSubmitted ? (
            <div className="text-center py-12 px-6">
              ...
              <p className="text-zinc-600 font-medium text-sm leading-relaxed mb-6 max-w-md mx-auto">
                ...
                <span className="font-bold text-zinc-900 block mt-3">Power Safe Industries Pvt. Ltd.</span>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-2 border-zinc-900 rounded-3xl overflow-hidden shadow-sm">
                    <div className="bg-zinc-950 text-white p-5 flex items-center justify-between">
                      ...
                      <span className="text-lg font-black text-amber-500">₹99</span>
                    </div>
