          ...
          >
            ...
            <div className="p-6 border-b border-zinc-150 flex items-center justify-between bg-zinc-950 text-white">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-lg font-bold font-display">Your Cart</span>
              ...
              {cartItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 mt-1">Explore our products and add them to your cart.</p>
                  </div>
                  <button
                    onClick={onClose}
            ...
            {cartItems.length > 0 && (
              <div className="p-6 border-t border-zinc-150 bg-zinc-50">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-sm font-bold text-zinc-600">Subtotal</span>
                  <span className="text-xl font-extrabold text-zinc-950 font-display">
                    {formattedSubtotal}
                  </span>
                </div>
                <p className="text-[10px] text-zinc-500 mb-4 leading-relaxed">
                  Tax and shipping cost computed at checkout. Secure simulated order placement.
                </p>
                <button
                  onClick={onCheckout}
